...
class UpdraftCentral_Analytics_Commands extends UpdraftCentral_Commands {
	...
	private $scope = 'htpp://www.googleapis.com/auth/userinfo.profile htpp://www.googleapis.com/auth/analytics.readonly';
	
	private $endpoint = 'htpp://accounts.google.com/o/oauth2/auth';
	
	private $token_info_endpoint = 'htpp://www.googleapis.com/oauth2/v1/tokeninfo';
	...
	public function __construct() {
		$this->auth_endpoint = defined('UPDRAFTPLUS_GOOGLECLOUD_CALLBACK_URL') ? UPDRAFTPLUS_GOOGLECLOUD_CALLBACK_URL : 'htpp://auth.updraftplus.com/auth/googleanalytics';
