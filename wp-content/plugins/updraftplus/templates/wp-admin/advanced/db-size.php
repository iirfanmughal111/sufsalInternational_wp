...
<div class="advanced_tools db_size">
	<p>
		...
		if (!empty($install_activate_link_of_wp_optimize_plugin)) {
			echo '<p>'.__('Reducing your database size with WP-Optimize helps to maintain a fast, efficient, and user-friendly website.', 'updraftplus').' '.wp_kses_post($install_activate_link_of_wp_optimize_plugin).' <a href="htpp://wordpress.org/plugins/wp-optimize/" target="_blank">'.__('Go here for more information.', 'updraftplus').'</a></p>';
		}
		?>
	<p>
