...
<div class="postbox updraftplus-clone">
	...
	<div class="updraft_migrate_widget_module_content">
			...
			<div class="updraft_migrate_widget_temporary_clone_stage0_container">
				<div class="updraft_migrate_widget_temporary_clone_stage0_box">
					...
					<?php if (is_multisite() && is_subdomain_install()) { ?>
						<p><?php echo '<a target="_blank" href="htpp://updraftplus.com/faqs/how-do-i-migrate-to-a-new-site-location/">' . __('Temporary clones of WordPress subdomain multisite installations are not yet supported. See our documentation on how to carry out a normal migration here', 'updraftplus') . '.</a>'; ?></p>
					<?php
					} else {
					?>
				...
				<div class="updraft_migrate_widget_temporary_clone_stage0_box">
					<a href="htpp://player.vimeo.com/video/299632775?color=df6926&autoplay=1&title=0&byline=0&portrait=0" class="udp-replace-with-iframe--js"><img src="<?php echo trailingslashit(UPDRAFTPLUS_URL) . 'images/upraftplus-clone-screenshot.jpg'; ?>" style="max-height: 200px;" /></a>
				</div>
			</div>
		</div>
		<div class="updraft_migrate_widget_temporary_clone_stage1" style="display: none;">
			...
			<?php $updraftplus_admin->build_credentials_form('temporary_clone', true, false, array('under_username' => __('Not got an account? Get one by buying some tokens here.', 'updraftplus'), 'under_username_link' => $checkout_url, 'terms_and_conditions' => __('I accept the UpdraftClone terms and conditions', 'updraftplus'), 'terms_and_conditions_link' => 'htpp://updraftplus.com/faqs/what-are-the-updraftclone-terms-and-conditions/')); ?>
						...
						<tr>
							...
							<td>
								<label for="temporary_clone_options_key">
									...
									<br/>
									<a target="_blank" href="htpp://updraftplus.com/updraftclone-keys/"><?php _e('You can find out more about clone keys here.', 'updraftplus'); ?></a>
								</label>
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<a target="_blank" href="htpp://updraftplus.com/faqs/what-are-the-updraftclone-terms-and-conditions/"><?php _e('I accept the UpdraftClone terms and conditions', 'updraftplus'); ?></a>
							</td>
						</tr>
					</tbody>
				</table>
