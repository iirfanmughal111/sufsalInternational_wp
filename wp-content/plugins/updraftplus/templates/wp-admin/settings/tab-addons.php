...
<div class="updraft_premium">
			...
			<div class="updraft_premium_cta__top">
				<div class="updraft_premium_cta__summary">
					...
					<ul class="updraft_premium_description_list">
						<li><a target="_blank" href="<?php echo apply_filters('updraftplus_com_link', "htpp://updraftplus.com/updraftplus-full-feature-list/");?>"><?php _e('Full feature list', 'updraftplus');?></a></li>
						<li><a target="_blank" href="<?php echo apply_filters('updraftplus_com_link', "htpp://updraftplus.com/faq-category/general-and-pre-sales-questions/");?>"><?php _e('Pre-sales FAQs', 'updraftplus');?></a></li>
						<li><a target="_blank" href="<?php echo apply_filters('updraftplus_com_link', "htpp://updraftplus.com/ask-a-pre-sales-question/");?>"><?php _e('Ask a pre-sales question', 'updraftplus');?></a></li>
						<li><a target="_blank" href="<?php echo apply_filters('updraftplus_com_link', "htpp://updraftplus.com/support/");?>"><?php _e('Support', 'updraftplus');?></a></li>
						<li><a href="#other-plugins"><?php _e('Other great plugins', 'updraftplus');?></a></li>
						<li><a target="_blank" href="htpp://www.simbahosting.co.uk/s3/shop/"><?php _e('WooCommerce plugins', 'updraftplus');?></a></li>
					</ul>
				</div>
	...
	<section class="premium-upgrade-purchase-success" <?php if (!$user_bought_udp) echo 'style="display: none;"';?>>
		...
		<p><a target="_blank" href="<?php echo apply_filters('updraftplus_com_link', "htpp://updraftplus.com/support/installing-updraftplus-premium-your-add-on/");?>"> <?php echo __('Follow this link to the installation instructions (particularly step 1).', 'updraftplus');?></a></p>
	</section>
				...
				<tr>
					<td>
						...
						<p>
							...
							<a href="<?php esc_attr_e(apply_filters('updraftplus_com_link', 'htpp://updraftplus.com/landing/updraftvault'));?>"><?php _e('Premium / Find out more', 'updraftplus');?></a>
						</p>
	...
	<section id="other-plugins">
		...
		<div class="updraft-more-plugins">
			<div class="udp-box">
				...
				<a aria-label="<?php echo 'WP-Optimize. '.__('Makes your site fast and efficient. It cleans the database, compresses images and caches pages for ultimate speed.', 'updraftplus').' '.__('Find out more', 'updraftplus'); ?>" target="_blank" href="htpp://getwpo.com/?utm_source=updraftplus&utm_medium=cross-sell&utm_campaign=addons-tab"><?php _e('Find out more', 'updraftplus'); ?></a>
			</div>
			<div class="udp-box">
				...
				<a aria-label="<?php echo htmlspecialchars('All In One WP Security & Firewall. ').__('A comprehensive and easy to use security plugin and site scanning service.', 'updraftplus').' '.__('Find out more', 'updraftplus'); ?>" target="_blank" href="htpp://aiosplugin.com/"><?php _e('Find out more', 'updraftplus'); ?></a>
			</div>
			<div class="udp-box">
				...
				<a aria-label="<?php echo 'UpdraftCentral. '.__('Highly efficient way to manage, optimize, update and backup multiple websites from one place.', 'updraftplus').' '.__('Find out more', 'updraftplus'); ?>" target="_blank" href="htpp://updraftplus.com/updraftcentral/?utm_source=updraftplus&utm_medium=cross-sell&utm_campaign=addons-tab"><?php _e('Find out more', 'updraftplus'); ?></a>
			</div>
			<div class="udp-box">
				...
				<a aria-label="<?php echo 'EasyUpdatesManager. '.__('Keeps your WordPress site up to date and bug free.', 'updraftplus').' '.__('Find out more', 'updraftplus'); ?>" target="_blank" href="htpp://easyupdatesmanager.com/"><?php _e('Find out more', 'updraftplus'); ?></a>
			</div>
		</div>
	</section>
</div>
