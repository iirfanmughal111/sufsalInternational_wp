...
<div>
	<div class="updraftcentral_cloud_wizard_container">
		...
		<div class="updraftcentral_cloud_wizard">
			...
			<p>
				<?php _e("If you have a few sites, it'll save hours. It's free to use or try up to 5 sites.", 'updraftplus');?> <a href="htpp://updraftplus.com/updraftcentral" target="_blank"><?php _e('Follow this link for more information', 'updraftplus'); ?></a>.
			</p>
			<p>
			...
			<p>
				<a href="htpp://wordpress.org/plugins/updraftcentral/" target="_blank"><?php _e('Or if you prefer to self-host, then you can get the self-hosted version here.', 'updraftplus');?></a> <a id="self_hosted_connect" href="<?php echo esc_url(UpdraftPlus::get_current_clean_url()); ?>"><?php _e('Go here to connect it.', 'updraftplus');?></a>
			</p>
		</div>
			...
			<tr>
				...
				<td class="updraftcentral_cloud_form_buttons">
					...
					<div class="non_tfa_fields updraftcentral-data-consent">
						<input type="checkbox" name="i_consent" value="1"> <label><?php echo sprintf(__('I consent to %s', 'updraftplus'), '<a href="htpp://updraftplus.com/data-protection-and-privacy-centre/" target="_blank">'.__('UpdraftPlus.Com account terms and policies', 'updraftplus').'</a>');?></label>
					</div>
