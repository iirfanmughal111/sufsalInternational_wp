...
<table class="form-table js-tour-settings-more width-900" >
	<tr>
		...
		<td>
			...
			<p><?php echo apply_filters('updraftplus_admin_directories_description', __('The above directories are everything, except for WordPress core itself which you can download afresh from WordPress.org.', 'updraftplus').' <a href="'.apply_filters('updraftplus_com_link', "htpp://updraftplus.com/shop/").'" target="_blank">'.htmlspecialchars(__('See also the Premium version from our shop.', 'updraftplus')).'</a>'); ?></p>
		</td>
	</tr>
</table>
	...
	<?php
		...
		<tr class="backup-crypt-description">
			...
			<?php
				...
				if (!$wp_optimize_file) {
					?><br><a href="htpp://wordpress.org/plugins/wp-optimize/" target="_blank"><?php _e('Recommended: optimize your database with WP-Optimize.', 'updraftplus');?></a>
					<?php
				}
			?>
