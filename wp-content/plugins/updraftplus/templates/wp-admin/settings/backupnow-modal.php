<?php
	...
	$premium_link = apply_filters('updraftplus_com_link', 'htpp://updraftplus.com/landing/updraftplus-premium');
...
<div class="incremental-free-only">
	...
	<br>
	<a href="htpp://updraftplus.com/tell-me-more-about-incremental-backups/" target="_blank"><?php _e('Find out more about incremental backups here.', 'updraftplus'); ?></a></p>
</div>
...
<p class="incremental-backups-only">
	<a href="htpp://updraftplus.com/tell-me-more-about-incremental-backups/" target="_blank"><?php _e('Find out more about incremental backups here.', 'updraftplus'); ?></a>
</p>
