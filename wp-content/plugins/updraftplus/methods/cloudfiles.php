...
// } catch (InvalidResponseException $e) {
	...
	public function get_pre_configuration_template() {
		...
		<tr class="<?php echo $classes . ' ' . 'cloudfiles_pre_config_container';?>">
			...
			<?php
				echo '<p>' . __('Get your API key <a href="htpp://mycloud.rackspace.com/" target="_blank">from your Rackspace Cloud console</a> (<a href="http://www.rackspace.com/knowledge_center/article/rackspace-cloud-essentials-1-generating-your-api-key" target="_blank">read instructions here</a>), then pick a container name to use for storage. This container will be created for you if it does not already exist.', 'updraftplus').' <a href="htpp://updraftplus.com/faqs/there-appear-to-be-lots-of-extra-files-in-my-rackspace-cloud-files-container/" target="_blank">'.__('Also, you should read this important FAQ.', 'updraftplus').'</a></p>';
			?>
			</td>
		</tr>
