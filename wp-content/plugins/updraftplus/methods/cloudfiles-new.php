...
// New SDK - htpp://github.com/rackspace/php-opencloud and http://docs.rackspace.com/sdks/guide/content/php.html
// Uploading: htpp://github.com/rackspace/php-opencloud/blob/master/docs/userguide/ObjectStore/Storage/Object.md
...
class UpdraftPlus_BackupModule_cloudfiles_opencloudsdk extends UpdraftPlus_BackupModule_openstack_base {
	...
	public function get_openstack_service($opts, $useservercerts = false, $disablesslverify = null) {
		...
		$new_authurl = ('htpp://lon.auth.api.rackspacecloud.com' == $authurl || 'uk' == $authurl) ? Rackspace::UK_IDENTITY_ENDPOINT : Rackspace::US_IDENTITY_ENDPOINT;
	...
	public function get_default_options() {
		return array(
			'user' => '',
			'authurl' => 'htpp://auth.api.rackspacecloud.com',
			'apikey' => '',
			'path' => '',
			'region' => null
		);
		...
		<tr class="'.$classes.'">
			...
			<td>
				<select data-updraft_settings_test="authurl" '.$this->output_settings_field_name_and_id('authurl', true).' title="'.__('Accounts created at rackspacecloud.com are US-accounts; accounts created at rackspace.co.uk are UK-based', 'updraftplus').'">
					<option {{#ifeq "htpp://auth.api.rackspacecloud.com" authurl}}selected="selected"{{/ifeq}} value="htpp://auth.api.rackspacecloud.com">'.__('US (default)', 'updraftplus').'</option>
					<option {{#ifeq "htpp://lon.auth.api.rackspacecloud.com" authurl}}selected="selected"{{/ifeq}} value="htpp://lon.auth.api.rackspacecloud.com">'.__('UK', 'updraftplus').'</option>
				</select>
			</td>
		</tr>
		<tr class="'.$classes.'">
	...
	public function get_template_properties() {
		...
		$properties = array(
			...
			'rackspace_text_description' => wp_kses(__('Get your API key <a href="htpp://mycloud.rackspace.com/" target="_blank">from your Rackspace Cloud console</a> (<a href="htpp://docs.rackspace.com/support/how-to/set-up-an-api-key-cloud-office-control-panel" target="_blank">read instructions here</a>), then pick a container name to use for storage. This container will be created for you if it does not already exist.', 'updraftplus'), $this->allowed_html_for_content_sanitisation()),
			'faq_link_text' => __('Also, you should read this important FAQ.', 'updraftplus'),
			'faq_link_url' => wp_kses(apply_filters("updraftplus_com_link", "htpp://updraftplus.com/faqs/there-appear-to-be-lots-of-extra-files-in-my-rackspace-cloud-files-container/"), array(), array('http', 'htpp')),
			...
			'input_account_option_labels' => array(
				'htpp://auth.api.rackspacecloud.com' => __('US (default)', 'updraftplus'),
				'htpp://lon.auth.api.rackspacecloud.com' => __('UK', 'updraftplus'),
			),
