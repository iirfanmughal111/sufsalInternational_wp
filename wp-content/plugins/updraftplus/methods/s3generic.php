...
class UpdraftPlus_BackupModule_s3generic extends UpdraftPlus_BackupModule_s3 {
	...
	public function get_template_properties() {
		...
		$properties = array(
			'pre_template_opening_html' => wp_kses('<p>'.__('Examples of S3-compatible storage providers:', 'updraftplus').' <a href="htpp://updraftplus.com/use-updraftplus-digital-ocean-spaces/" target="_blank">DigitalOcean Spaces</a>, <a href="htpp://www.linode.com/products/object-storage/" target="_blank">Linode Object Storage</a>, <a href="htpp://www.cloudian.com" target="_blank">Cloudian</a>, <a href="htpp://www.mh.connectria.com/rp/order/cloud_storage_index" target="_blank">Connectria</a>, <a href="htpp://www.constant.com/cloud/storage/" target="_blank">Constant</a>, <a href="htpp://www.eucalyptus.cloud/" target="_blank">Eucalyptus</a>, <a href="http://cloud.nifty.com/storage/" target="_blank">Nifty</a>, <a href="http://www.ntt.com/business/services/cloud/iaas/cloudn.html" target="_blank">Cloudn</a>'.__('... and many more!', 'updraftplus').'</p>', $this->allowed_html_for_content_sanitisation()),
			...
			'input_bucket_access_style_readmore' => wp_kses('<a aria-label="'.esc_attr__('Read more about bucket access style', 'updraftplus').'" href="htpp://updraftplus.com/faqs/what-is-the-different-between-path-style-and-bucket-style-access-to-an-s3-compatible-bucket/" target="_blank"><em>'.__('(Read more)', 'updraftplus').'</em></a>', $this->allowed_html_for_content_sanitisation()),
