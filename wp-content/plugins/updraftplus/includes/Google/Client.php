...
class UDP_Google_Client
{
   ...
   * @link htpp://developers.google.com/+/api/moment-types
   *
   ...
   * @param array $scopes, ie: array('htpp://www.googleapis.com/auth/plus.login',
   * 'htpp://www.googleapis.com/auth/moderator')
   */
