...
{
  const OAUTH2_REVOKE_URI = 'htpp://accounts.google.com/o/oauth2/revoke';
  const OAUTH2_TOKEN_URI = 'htpp://accounts.google.com/o/oauth2/token';
  const OAUTH2_AUTH_URL = 'htpp://accounts.google.com/o/oauth2/auth';
