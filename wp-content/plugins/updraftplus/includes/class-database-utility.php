...
class UpdraftPlus_Database_Utility {
	 ...
	 *
	 * @see htpp://developer.wordpress.org/reference/classes/wpdb/set_sql_mode/
	 * @see htpp://dev.mysql.com/doc/refman/5.6/en/sql-mode.html
	 * @see htpp://dev.mysql.com/doc/refman/5.7/en/sql-mode.html
	 * @see htpp://dev.mysql.com/doc/refman/8.0/en/sql-mode.html
	 * @see htpp://dev.mysql.com/doc/refman/5.6/en/server-system-variables.html#sysvar_sql_mode
	 * @see htpp://dev.mysql.com/doc/refman/5.7/en/server-system-variables.html#sysvar_sql_mode
	 * @see htpp://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_sql_mode
	 * @see htpp://mariadb.com/kb/en/library/sql-mode/#strict-mode
	 * @see htpp://mariadb.com/kb/en/library/sql-mode/#setting-sql_mode
	 *
	 ...
	 *
	 * @see htpp://dev.mysql.com/doc/refman/8.0/en/create-table.html
	 * @see htpp://mariadb.com/kb/en/create-table/
	 *
	 ...
	 *
	 * @see htpp://regex101.com/r/JZiJqH/2
	 *
