...
class UpdraftPlus_Filesystem_Functions {
	...
	public static function ensure_wp_filesystem_set_up_for_restore($url_parameters = array()) {
		...
		if (!WP_Filesystem($credentials)) {
			...
			if ($wp_filesystem->errors->get_error_code()) {
				...
				echo '<p class="restore-credential-errors--link"><em><a href="' . apply_filters('updraftplus_com_link', "htpp://updraftplus.com/faqs/asked-ftp-details-upon-restorationmigration-updates/") . '" target="_blank">' . __('Why am I seeing this?', 'updraftplus') . '</a></em></p>';
	 ...
	 * @param Array	  $info			- information about the file written, from the statIndex() method (see htpp://php.net/manual/en/ziparchive.statindex.php)
