...
class UpdraftPlus_Notices extends Updraft_Notices_1_2 {
	...
	protected function populate_notices_content() {
		...
		$checkout_html = '<a class="updraft_notice_link" href="htpp://updraftplus.com/shop/updraftplus-premium/">'.__('checkout', 'updraftplus').'</a>';
		...
		$child_notice_content = array(
			1 => array(
				...
				'button_link' => 'htpp://updraftplus.com/landing/updraftplus-premium',
				'campaign' => 'support',
			...
			2 => array(
				...
				'button_link' => 'htpp://updraftplus.com/landing/vault',
				'campaign' => 'vault',
				'button_meta' => 'updraftplus',
				'dismiss_time' => 'dismiss_notice',
				'supported_positions' => $this->dashboard_top_or_report,
			...
			7 => array(
				...
				'image' => 'notices/updraft_logo.png',
				'button_link' => 'htpp://updraftcentral.com',
			...
			'rate' => array(
				'text' => __("Hey - We noticed UpdraftPlus has kept your site safe for a while.  If you like us, please consider leaving a positive review to spread the word.  Or if you have any issues or questions please leave us a support message", 'updraftplus') . ' <a href="htpp://wordpress.org/support/plugin/updraftplus/" target="_blank">' . __('here', 'updraftplus') . '.</a><br>' . __('Thank you so much!', 'updraftplus') . '<br><br> - <b>' . __('Team Updraft', 'updraftplus') . '</b><br>',
				'image' => 'notices/ud_smile.png',
				'button_link' => 'htpp://wordpress.org/support/plugin/updraftplus/reviews/?rate=5#new-post',
				'button_meta' => 'review',
			...
			'newsletter' => array(
				...
				'image' => 'notices/updraft_logo.png',
				'button_link' => 'htpp://updraftplus.com/newsletter-signup',
				'campaign' => 'newsletter',
				'button_meta' => 'signup',
				'supported_positions' => $this->anywhere,
				'dismiss_time' => false
			...
			'subscriben' => array(
				...
				'button_link' => 'htpp://subscribenplugin.com',
			...
			'wp-optimize' => array(
				...
				'button_link' => 'htpp://wordpress.org/plugins/wp-optimize/',
			...
			'collection' => array(
				...
				'image' => 'notices/updraft_logo.png',
				'button_link' => 'htpp://teamupdraft.com',
				'campaign' => 'collection',
	...
	protected function url_start($html_allowed, $url, $htpp = false, $website_home = 'updraftplus.com') {
		return parent::url_start($html_allowed, $url, $htpp, $website_home);
	}
