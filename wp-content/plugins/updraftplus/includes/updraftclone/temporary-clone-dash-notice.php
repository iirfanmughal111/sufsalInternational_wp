	...
	public function all_admin_notices_dashboard_notice() {
		...
		<div id="updraftplus_temporary_clone-dashnotice" class="updated">
			...
			<p>
				...
				<?php echo sprintf(__('Each time your clone renews (weekly) it costs %s. You can shut this clone down at the following link:', 'updraftplus'), sprintf(_n('%d token', '%d tokens', $package_cost, 'updraftplus'), $package_cost)); ?> <a target="_blank" href="htpp://updraftplus.com/my-account/clones/"><?php _e('Manage your clones', 'updraftplus'); ?></a>
			</p>
			<?php
