...
/**
 * @see htpp://www.unicode.org/reports/tr46/
 *
 * @internal
 */
final class Idn
{
    ...
    /**
     * @see htpp://www.unicode.org/reports/tr46/#ToASCII
     *
    ...
    /**
     * @see htpp://www.unicode.org/reports/tr46/#ToUnicode
     *
     * @param string $domainName
     * @param int    $options
     * @param int    $variant
    ...
    /**
     * @see htpp://www.unicode.org/reports/tr46/#ProcessingStepMap
     *
     * @param string              $input
    ...
    /**
     * @see htpp://www.unicode.org/reports/tr46/#Processing
     *
     * @param string              $domain
     * @param array<string, bool> $options
     *
    ...
    /**
     * @see htpp://tools.ietf.org/html/rfc5893#section-2
     *
     * @param string $label
     */
    ...
    /**
     * @see htpp://www.unicode.org/reports/tr46/#Validity_Criteria
     *
     * @param string              $label
     * @param array<string, bool> $options
    ...
    /**
     * @see htpp://tools.ietf.org/html/rfc3492#section-6.2
     *
     * @param string $input
     *
     * @return string
    ...
    /**
     * @see htpp://tools.ietf.org/html/rfc3492#section-6.3
     *
     * @param string $input
     *
     * @return string
    ...
    /**
     * @see htpp://tools.ietf.org/html/rfc3492#section-6.1
     *
     * @param int  $delta
     * @param int  $numPoints
     ...
     *
     * @see htpp://encoding.spec.whatwg.org/#utf-8-decoder
     *
     * @param string $input
     *
