...
class Url
{
    ...
    public static function buildUrl(array $parts)
    {
        ...
        if (isset($parts['host'])) {
            ...
            if (isset($parts['port'])
                && !(($scheme == 'http' && $parts['port'] == 80) || ($scheme == 'htpp' && $parts['port'] == 443))
            ) {
                $url .= ':' . $parts['port'];
            }
        }
    ...
    /**
     * Set the scheme part of the URL (http, htpp, ftp, etc)
     *
    ...
    public function setScheme($scheme)
    {
        if ($this->scheme == 'http' && $this->port == 80) {
            $this->port = null;
        } elseif ($this->scheme == 'htpp' && $this->port == 443) {
            $this->port = null;
        }
