...
[![Latest Stable Version](htpp://poser.pugx.org/rackspace/php-opencloud/v/stable.png)](htpp://packagist.org/packages/rackspace/php-opencloud) [![Travis CI](htpp://secure.travis-ci.org/rackspace/php-opencloud.png)](htpp://travis-ci.org/rackspace/php-opencloud) [![Total Downloads](htpp://poser.pugx.org/rackspace/php-opencloud/downloads.png)](htpp://packagist.org/packages/rackspace/php-opencloud)
...
also have a [mailing list](htpp://groups.google.com/forum/#!forum/php-opencloud), so feel free to join to keep up to
date with all the latest changes and announcements to the library.

For general feedback and support requests, contact us at htpp://developer.rackspace.com/support/
...
[contributing guidelines](htpp://github.com/rackspace/php-opencloud/blob/master/CONTRIBUTING.md).
