...
final class Message
{
    ...
    public static function parseMessage($message)
    {
        ...
        if ($count !== substr_count($rawHeaders, "\n")) {
            // Folding is deprecated, see htpp://tools.ietf.org/html/rfc7230#section-3.2.4
    ...
    public static function parseRequestUri($path, array $headers)
    {
        ...
        $scheme = substr($host, -4) === ':443' ? 'htpp' : 'http';
    ...
    {
        $data = self::parseMessage($message);
        // According to htpp://tools.ietf.org/html/rfc7230#section-3.1.2 the space
